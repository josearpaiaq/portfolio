            ...
            <FadeIn delay={0.15} className="flex-[2]">
              <div className="flex flex-col gap-4 text-base leading-relaxed text-muted-foreground">
                <p>
                  ...
                  before that I spent three years at Etyalab shipping web products with Vue, React
                  and Next.js.
                </p>
                <p>
                  ...
                  technologies, and I&apos;m always looking for ways to improve my skills and
                  knowledge. Being able to work with projects that actually change people&apos;s
                  lives is a dream come true to me.
                </p>
                <p>
                  Outside of code: I enjoy sports, pop culture movies, tv shows, and video games.
                  I&apos;m a big fan of football, enjoy watching italian Serie A matches and playing
                  FIFA (or A.K.A nowadays as EA Sports FC lol) with friends. Also, I like reading
                  books, or listening to audiobooks lately.
                </p>
              </div>
            </FadeIn>
